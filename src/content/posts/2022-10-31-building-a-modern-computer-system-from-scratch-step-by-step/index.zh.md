...
> 有时并不是技术本身真的很难，而是你遇到了糟糕的教材，或者没有遇到好老师。我认为编写优秀的经典的教材虽然很少，但却是一直存在的，而且也很容易获得，只是往往会被巨量而劣质的信息所掩盖。选择对的教材很重要。
...
我们知道现代的计算机技术无比庞大，无比复杂，各式各样的领域和框架、层出不穷的工具、转瞬即逝的新旧迭代速度，让人眼花缭乱，我们穷其一生都未必能学完。不过如果我们抛开表层而不断地向底层研究，就会发现事情会变得越来越单纯，越来越简单（当然过程是艰苦的），到最后终点站时，我们就会犹如来到大爆炸的那一刻，之前那些让人头晕脑胀的表层技术一下子就变得无比简单了。第一个系列正是这样的一个 “透过现象看本质” 的过程，主要的目的是为了认识计算机技术当中最底层也是最简单的原理。

> 很多人都看过 [_曼德博集合_](https://en.wikipedia.org/wiki/Mandelbrot_set)（Mandelbrot set）的[分形图形](https://en.wikipedia.org/wiki/Fractal)，这种图形可以无限地放大和移动，而且总会有不重复的图形产生。我们可以像浏览我们宇宙的星系一样，花上一整天的时间来遨游这个美丽的世界而不会觉得枯燥。但让人难以接受的是，这个无比庞大、无比复杂的宇宙其实只是一条无比简单的数学函数产生的：$y = x^2 + z$，只需把 $y$ 的值不断代入 $x$，大爆炸就此产生了。
