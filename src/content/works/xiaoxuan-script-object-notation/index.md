...
E,P,T,G,M,K     <-- ulong(default)/long
m,u,n,p,f,a     <-- float(default)/double
...
> only available for decimal numbers and the data type must be "unsign long, long" or "float, double".
